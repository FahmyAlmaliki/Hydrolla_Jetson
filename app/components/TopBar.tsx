...
export default function TopBar() {
  ...
  return (
    <header
      className="fixed top-0 right-0 z-40 h-16 border-b border-[var(--color-outline-variant)] flex items-center justify-between px-6"
      style={{
        left: "272px",
    ...
    >
      ...
      <div>
        <h2 className="text-base font-semibold" style={{ color: "var(--color-on-surface)" }}>
          HYDROLA
          <span className="font-normal mx-1.5" style={{ color: "var(--color-outline-variant)" }}>·</span>
          <span style={{ color: "var(--color-on-surface-variant)" }}>Pemantauan Akuaponik</span>
        </h2>
      </div>
      ...
      <div className="flex items-center gap-5">
        ...
        <div className={[
          ...
          {online ? "Sistem Online" : "Offline"}
        </div>

        {/* Date & time */}
        <div className="text-xs text-right hidden sm:block" style={{ color: "var(--color-on-surface-variant)" }}>
